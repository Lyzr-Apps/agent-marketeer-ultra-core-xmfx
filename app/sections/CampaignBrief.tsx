      ...
      <div className="relative ml-auto w-full max-w-lg bg-card border-l border-border shadow-2xl h-full overflow-y-auto animate-in slide-in-from-right duration-300">
        ...
        {isGenerating ? (
          <div className="p-6 flex flex-col items-center justify-center min-h-[400px]">
            <div className="w-full max-w-sm">
              <div className="flex items-center justify-center mb-6">
                <div className="w-16 h-16 rounded-2xl flex items-center justify-center animate-pulse bg-gradient-sunset">
              ...
              <div className="w-full bg-muted rounded-full h-2 mb-4 overflow-hidden">
                <div className="h-full rounded-full transition-all duration-700 ease-out bg-gradient-sunset-90" style={{ width: `${progressPercent}%` }} />
              </div>
          ...
          <div className="p-6 space-y-5">
            ...
            <Button onClick={handleSubmit} disabled={!topic.trim() || channels.length === 0} className="w-full bg-gradient-sunset text-primary-foreground font-medium py-5 shadow-lg hover:shadow-xl transition-all duration-300">
